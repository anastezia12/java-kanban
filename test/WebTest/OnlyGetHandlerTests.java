...
abstract class OnlyGetHandlerTests {
    ...
    OnlyGetHandlerTests(URI historyUri) throws IOException {
        this.url = historyUri;
    }
    ...
    @Test
    public void shouldReturnEmptyListIfNothingThere() throws IOException, InterruptedException {
    ...
    @Test
    public void shouldReturnListAfterAccessingTask() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .GET()
                .build();
        HttpResponse<String> historyResponse = client.send(request, HttpResponse.BodyHandlers.ofString());

        assertEquals(200, historyResponse.statusCode());
        assertTrue(historyResponse.body().contains("name"));
    }
}
